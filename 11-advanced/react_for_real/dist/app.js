...
var MySlider = React.createClass({displayName: 'MySlider',
  render: function() {
    return (
      React.createElement("div", null, 
        React.createElement("input", {type: "range", 
          ...
          max: this.state.max}), 
        React.createElement("input", {type: "text", value: this.state.val, onChange: this.updateVal})
      )
    ) 
  },
...
var AppComp = React.createClass({displayName: 'AppComp',
  render: function() {
    return (
      React.createElement("div", {className: "box"}, 
        React.createElement(MySlider, null), 
        React.createElement(MySlider, {val: "7", max: "10"})
      )
    )
  }
})

React.render(React.createElement(AppComp, null), document.getElementById('app'));
